...
function draw() {
 ...
 function keyPressed(){
	 if (keyCode===UP_ARROW){
		 ...
		 Matter.Body.applyForce(bob2.body,bob2.position,{x:-50,y:-45});
		 Matter.Body.applyForce(bob3.body,bob3.position,{x:-50,y:-45});
		 Matter.Body.applyForce(bob4.body,bob4.position,{x:-50,y:-45});
